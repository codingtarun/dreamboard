...
```mermaid
quadrantChart
    title Competitive Positioning: Agri-Tech Apps in India
    x-axis Generic / Broad --> Specialized / Niche
    y-axis Low Digital --> High Digital
    quadrant-1 Underserved Niche
    quadrant-2 Premium Specialists
    quadrant-3 Basic / Generic
    quadrant-4 Traditional / Offline
    "IFFCO Kisan": [0.2, 0.5]
    "Kisan Suvidha": [0.2, 0.4]
    "Crop Analytica": [0.5, 0.7]
    "Orchard Solutions": [0.8, 0.3]
    "farmOS": [0.4, 0.6]
    "Agworld": [0.6, 0.8]
    "Semios": [0.7, 0.9]
