...
Warm minimalism, geometric precision, earthy premium, builder aesthetic, human-centric tech.

## Mood

Confident and approachable — a senior engineer who designs. Clean code meets warm terracotta. Like a well-lit maker space with espresso wood desks.

## Graphic Design Rules

- Use geometric shapes (rectangles, circles, lines) as decorative accents
- Terracotta blocks at bottom of compositions for brand anchoring
- High contrast between dark text and light backgrounds (or vice versa)
- Keep whitespace generous — never overcrowd
- Use the primary color sparingly for maximum impact (headlines, key shapes, CTAs)
